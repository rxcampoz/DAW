...
function cargarNoticias()
{
	...
	xRequest.open("GET","xml/Noticias.xml",true);
	xRequest.send();
}
...
function llenarNoticias(responseXML){
	...
	for(i=0;i<listaNoticias.length;i++)
	{
		...
		$img = listaNoticias[i].getElementsByTagName("img-path")[0].firstChild.nodeValue;
		$link = listaNoticias[i].getElementsByTagName("link")[0].firstChild.nodeValue;
