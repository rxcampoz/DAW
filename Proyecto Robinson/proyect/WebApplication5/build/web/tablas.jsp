...
<body class="yui-skin-sam">
    ...
    <div id="container">
        <table id="accounts">
            ...
            <tbody>
            <c:forEach items="${modelo.facturas}" var="row">
                <tr>
                   <td>
                    
                            <a href="Administrador_de_ingresos_SERVLET?opcion=modificar">Modificar</a>
                    </td>
                    ...
                    <td>
                            ...
                            <a href="Administrador_de_ingresos_SERVLET?opcion=eliminar&id=${row.numeroFactura}">Eliminar</a>
                    </td>
