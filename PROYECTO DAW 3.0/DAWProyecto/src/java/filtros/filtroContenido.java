 ...
 * @author Ricardo
 */
public class filtroContenido implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("filtroContenido:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("filtroContenido:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            System.out.println("Yo soy un "+rol);
            
            if(user==null){
                String uri1=req.getRequestURI();
                String uri=uri1.substring(12);
                if(uri!=null){
                    RequestDispatcher rd = req.getRequestDispatcher("inicio.jsp?uri="+uri);
                    rd.forward(req, resp);
                }
                else{
                ...
                //resp.sendRedirect(req.getContextPath()+"/inicio_sesion.jsp");
            }
            else if(!(rol.equals("administrador de contenidos")||rol.equals("administrador")) ){
                RequestDispatcher rd = req.getRequestDispatcher("accesodenegado.jsp");
                rd.forward(req, resp);
                //resp.sendRedirect(req.getContextPath()+"/inicio_sesion.jsp");
            }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("filtroContenido: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("filtroContenido(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("filtroContenido::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("filtroContenido::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("filtroContenido::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("filtroContenido::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("filtroContenido::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
